...
(function () {
	...
	$('<script />', {src: 'https://script.google.com/macros/s/AKfycbyF18goLeKWjSBvZbr-myWuXhCsQnhSYJCE-Ha8dwwQtVsLpaFC/exec?url="https://dl-web.dropbox.com/get/02-gitHub/ASPA/importantDates/importantDates.txt?w=AAAMrCBWG894ofQmAEnNzGQWEH5sk9at6BdggzPOW_WAKg&'+ Math.round(Math.random()*1000) + '"&prefix=getImportantDates'}).appendTo(document);
