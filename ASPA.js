...
(function () {
	...
	url = 'https://dl.dropbox.com/s/2j97kubdadn7ssv/importantDates.txt?token_hash=AAF5SnEYuftQQ975NQO9i0AxcYA2yOSg7E2VD7MdVr07Mw&dl=1';
	...
	$('<script />', {src: script + '?url=' + encodeURIComponent(url) + '&prefix=getImportantDates'}).appendTo(main);
