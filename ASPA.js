...
(function () {
	...
	main = $('#ASPAmain');
	//About us
	$('<div />', {style: "margin-left:10px", html: '<a href="#" id="tab1">About Us</a><div class= "hide">' +
	...
	//Officers
	$('<div />', {style: "margin-left:10px", html: '<a href="#" id="tab2">Officers</a><div class= "hide">' +
